...
struct DiscreteScroll {
    ...
    private static let accessibilityNotificationName: Notification.Name = Notification.Name("com.apple.accessibility.api")
    
    private static let defaultLineCount: Int64 = 3
    
    private static let keyLineCount = "lines"
    ...
    private func waitUntilTrusted() async {
    ...
    private func setupObserveScroll() {
    ...
    /// エラーダイアログを表示して終了
    private func displayNoticeAndExit(_ alertHeader: String) -> Never {
